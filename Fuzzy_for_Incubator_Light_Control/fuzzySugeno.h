...
private:
  const float Hi = 140, N = 120, Lo = 80;
  float rule[3][5] = {
    // Constant Value
  ...
  void calculateValue() {
    ...
    valueDeltaError[1] = deltaError_Z(deltaError);
    valueDeltaError[2] = deltaError_DP(deltaError);
  }
